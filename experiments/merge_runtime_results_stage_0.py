#!/usr/bin/env python3
"""Stage 0: gather the timestamps_<METHOD>_<GRID> folders from each per-method runtime
output folder into ONE common folder, so stage 1 can aggregate them.
...
overwrites (dirs_exist_ok), so it is idempotent. Then run merge_runtime_results_stage_1.py.
"""
